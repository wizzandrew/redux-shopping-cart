...
export function Cart() {
  ...
  //used: <table className={tableClasses}>
  ...
  return (
    <main className="page">
      ...
      <table className={tableClasses}>
        ...
        <tbody>
          {/* Object.entries returns an array(items) of arrays(item)
          the item array contains key and value */}
            ...
            <tr key={id}>
              ...
              <td>
                <input
                  ...
                  //onBlur makes the "input" for quantity open for modification 
